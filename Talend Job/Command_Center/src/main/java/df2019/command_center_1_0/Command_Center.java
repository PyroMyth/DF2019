...
package df2019.command_center_1_0;
...
/**
 * Job: Command_Center Purpose: Control the flow and order of the data migration<br>
 * Description: This job controls the flow of the data migration, including the order of migration objects. <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status 
 */
public class Command_Center implements TalendJob {
	...
	private final String jobName = "Command_Center";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Command_Center.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Command_Center.this, new Object[] { e,
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_DF2019_Command_Center = new byte[0];
		static byte[] commonByteArray_DF2019_Command_Center = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DF2019_Command_Center.length) {
					if (length < 1024
							&& commonByteArray_DF2019_Command_Center.length == 0) {
						commonByteArray_DF2019_Command_Center = new byte[1024];
					} else {
						commonByteArray_DF2019_Command_Center = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DF2019_Command_Center, 0, length);
				strReturn = new String(commonByteArray_DF2019_Command_Center,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DF2019_Command_Center) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				java.io.File file_tFileInputProperties_1 = new java.io.File(
						context.filePath + "/talend.properties");
				...
				try {
					...
					while (enumeration_tFileInputProperties_1.hasMoreElements()) {
						...
						// Get values from properties file and put into context
						// variables
						if (row1.key != null
								&& row1.key.equalsIgnoreCase("destURL")) {
							context.destURL = row1.value;
						} else if (row1.key != null
								&& row1.key.equalsIgnoreCase("destUser")) {
							context.destUser = row1.value;
						} else if (row1.key != null
								&& row1.key.equalsIgnoreCase("destPass")) {
							context.destPass = row1.value;
						} else if (row1.key != null
								&& row1.key.equalsIgnoreCase("sourceURL")) {
							context.sourceURL = row1.value;
						} else if (row1.key != null
								&& row1.key.equalsIgnoreCase("sourceUser")) {
							context.sourceUser = row1.value;
						} else if (row1.key != null
								&& row1.key.equalsIgnoreCase("sourcePass")) {
							context.sourcePass = row1.value;
						} else if (row1.key != null
								&& row1.key.equalsIgnoreCase("dateTimeString")) {
							context.dateTimeString = row1.value;
						} else if (row1.key != null
								&& row1.key.equalsIgnoreCase("dateString")) {
							context.dateString = row1.value;
						}
						nb_line_tJavaRow_1++;
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				paraList_tRunJob_2.add("--context=Sandbox");
				...
				parentContextMap_tRunJob_2
						.put("dateString", context.dateString);

				parentContextMap_tRunJob_2.put("dateTimeString",
						context.dateTimeString);

				parentContextMap_tRunJob_2.put("destPass", context.destPass);

				parentContextMap_tRunJob_2.put("destURL", context.destURL);

				parentContextMap_tRunJob_2.put("destUser", context.destUser);

				parentContextMap_tRunJob_2.put("doDML", context.doDML);

				parentContextMap_tRunJob_2.put("exportRecordsFromDest",
						context.exportRecordsFromDest);

				parentContextMap_tRunJob_2.put("exportRecordsFromSource",
						context.exportRecordsFromSource);

				parentContextMap_tRunJob_2.put("filePath", context.filePath);

				parentContextMap_tRunJob_2
						.put("sourcePass", context.sourcePass);

				parentContextMap_tRunJob_2.put("sourceURL", context.sourceURL);

				parentContextMap_tRunJob_2
						.put("sourceUser", context.sourceUser);

				Object obj_tRunJob_2 = null;

				df2019.dest_pullcommonrecords_1_0.Dest_PullCommonRecords childJob_tRunJob_2 = new df2019.dest_pullcommonrecords_1_0.Dest_PullCommonRecords();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				paraList_tRunJob_3.add("--context=Sandbox");
				...
				parentContextMap_tRunJob_3.put("dateTimeString",
						context.dateTimeString);

				parentContextMap_tRunJob_3.put("destPass", context.destPass);

				parentContextMap_tRunJob_3.put("destURL", context.destURL);

				parentContextMap_tRunJob_3.put("destUser", context.destUser);

				parentContextMap_tRunJob_3.put("doDML", context.doDML);

				parentContextMap_tRunJob_3.put("exportRecordsFromDest",
						context.exportRecordsFromDest);

				parentContextMap_tRunJob_3.put("exportRecordsFromSource",
						context.exportRecordsFromSource);

				parentContextMap_tRunJob_3.put("filePath", context.filePath);

				parentContextMap_tRunJob_3
						.put("sourcePass", context.sourcePass);

				parentContextMap_tRunJob_3.put("sourceURL", context.sourceURL);
				...
				df2019.migrate_accounts_1_0.Migrate_Accounts childJob_tRunJob_3 = new df2019.migrate_accounts_1_0.Migrate_Accounts();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				paraList_tRunJob_4.add("--context=Sandbox");
				...
				parentContextMap_tRunJob_4.put("dateTimeString",
						context.dateTimeString);

				parentContextMap_tRunJob_4.put("destPass", context.destPass);

				parentContextMap_tRunJob_4.put("destURL", context.destURL);

				parentContextMap_tRunJob_4.put("destUser", context.destUser);

				parentContextMap_tRunJob_4.put("doDML", context.doDML);

				parentContextMap_tRunJob_4.put("exportRecordsFromDest",
						context.exportRecordsFromDest);

				parentContextMap_tRunJob_4.put("exportRecordsFromSource",
						context.exportRecordsFromSource);

				parentContextMap_tRunJob_4.put("filePath", context.filePath);

				parentContextMap_tRunJob_4
						.put("sourcePass", context.sourcePass);

				parentContextMap_tRunJob_4.put("sourceURL", context.sourceURL);
				...
				df2019.migrate_contacts_1_0.Migrate_Contacts childJob_tRunJob_4 = new df2019.migrate_contacts_1_0.Migrate_Contacts();
				// pass DataSources
	...
	public static void main(String[] args) {
		final Command_Center Command_CenterClass = new Command_Center();

		int exitCode = Command_CenterClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Command_Center.class
					.getClassLoader().getResourceAsStream(
							"df2019/command_center_1_0/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Command_Center");
		}
...
/************************************************************************************************
 * 58377 characters generated by Talend Open Studio for Data Integration on the
